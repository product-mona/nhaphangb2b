        ...
        <div className="container">
          <div className={styles.inner}>
            ...
            <div className="col-span-4 md:col-span-4 lg:col-span-2 xl:col-span-1">
              ...
              <p className="mt-3">
                Chúng tôi chuyên nhận order và vận chuyển hộ hàng hóa từ Trung
                Quốc về Việt Nam, với chi phí ưu đãi thấp nhất có thể. Hàng về
                nhanh chóng đúng thời gian cam kết.
              </p>
            </div>
                ...
                <div className={styles.contactBox}>
                  ...
                  >
                    ...
                    <span className="flex flex-col">
                      <span>
                        Hotline:{" "}
                        <span className={`${styles.colorD} ml-2`}>
                          {dataConfig?.Hotline}
                        </span>
                      </span>
                      <span>
