...
export const MessageControlUser = ({ clientId, mainOrderId }) => {
	...
	const { isFetchingNextPage, hasNextPage, fetchNextPage, isLoading } = useInfiniteQuery(
		...
		},
		{
			...
			onSuccess: (data) => {
				...
				setMessages((preState) => sortMessageByNewestDate([...preState, ...filteredLastPage]))
			}
		}
	)
	...
	return (
		<>
			<div
				className={clsx('bottom-[0px] right-[80px] flex-row-reverse fixed flex grid-cols-2 h-[440px] z-[9999]', {
