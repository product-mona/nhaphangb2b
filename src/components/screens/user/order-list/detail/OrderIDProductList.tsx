						...
						<div className="flex w-7/12">
							<div className="block flex md:flex-col justify-between ml-2 w-1/4">
								...
								<div className="text-sm text-center">
									<InputNumber size="middle" value={_format.getVND(item?.Quantity, '')} disabled={true} />
								</div>
							</div>
							<div className="block flex md:flex-col justify-between ml-2 w-1/4">
								...
								<div className="text-orange">
									<div className="text-sm text-center">
										<InputNumber size="middle" value={_format.getVND(item?.UPriceBuy, '')} disabled={true} />
									</div>
								</div>
							</div>
							<div className="block flex md:flex-col justify-between ml-2 w-1/4">
								...
								<div className="text-orange">
									<div className="text-sm text-center">
										<InputNumber size="middle" value={_format.getVND(item?.UPriceBuyVN, '')} disabled={true} />
									</div>
								</div>
							</div>
							<div className="block flex md:flex-col justify-between ml-2 w-1/4">
