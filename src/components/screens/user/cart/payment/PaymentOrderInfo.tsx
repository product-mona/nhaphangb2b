					...
					<div className="flex">
						...
						<div className="w-[75px] h-[75px] border border-[#6969691a] ml-4 rounded-xl overflow-hidden">
							<a href={orderTemp?.LinkOrigin} target="_blank">
								<img src={_format.parseImageURL(orderTemp?.ImageOrigin)} width="100%" height="100%" />
							</a>
						</div>
					</div>
					<div className="ml-2">
				...
				<div className="grid grid-cols-2 gap-6">
					<div className="col-span-1">
						<div className="tableBox bg-[#f3f6fa] !py-0 !m-0 !h-fit">
							<div className="p-3">
								<div className="text-base flex justify-between w-full pb-3">
					...
					<div className="col-span-1">
						<div className="grid grid-cols-2 mb-4 pb-4 col-span-1 border-[#56545454] border-b">
							<Checkbox className="transfer col-span-1" disabled checked={orderShopTempData?.IsFastDelivery}>
								Giao tận nhà
							</Checkbox>
							<Checkbox className="transfer col-span-1" disabled checked={orderShopTempData?.IsCheckProduct}>
								Kiểm hàng
							</Checkbox>
							<Checkbox className="transfer col-span-1 !ml-0" disabled checked={orderShopTempData?.IsPacked}>
								Đóng gỗ
							</Checkbox>
							<Checkbox className="transfer col-span-1" disabled checked={orderShopTempData?.IsInsurance}>
								Bảo hiểm
							</Checkbox>
						</div>
						{/* <div className="">
