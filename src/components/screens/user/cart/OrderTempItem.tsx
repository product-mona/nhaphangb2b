...
export const OrderTempItem: React.FC<TProps> = ({
  index,
  orderTempData,
  updateProduct,
  deleteProduct,
          ...
          <div className="flex">
            ...
            <div className="w-[75px] h-[75px] border border-[#6969691a] ml-4 rounded-xl overflow-hidden">
              <Link href={orderTempData?.LinkOrigin}>
                <a target="_blank">
                  <img
                    src={_format.parseImageURL(orderTempData?.ImageOrigin)}
                    width="100%"
                    height="100%"
                  />
                </a>
          ...
          <div className="grid grid-cols-1 xl:!grid-cols-2">
            ...
            <div className="col-span-1 lg:!col-span-1 xl:block flex justify-between ml-2 mb-2 xl:mb-0">
              ...
              <div className="text-sm text-center">
                <InputNumber
                  size="middle"
                  value={_format.getVND(orderTempData?.EPriceBuyVN, "")}
                  disabled={true}
                />
              </div>
            </div> */}
