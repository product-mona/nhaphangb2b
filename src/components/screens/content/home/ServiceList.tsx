...
export const ServiceList: React.FC<TTable<TService> & { refetchService }> = ({ data, refetchService }) => {
	const columns: TColumnsType<TService> = [
		...
		},
		{
			...
			align: 'center',
			title: 'Hình ảnh',
			render: (_, record) => <img src={record.IMG} width={40} height={40} style={{ margin: 'auto' }} />
		},
		{
			dataIndex: 'Name',
			title: 'Tên dịch vụ'
