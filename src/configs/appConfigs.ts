...
export const cartData = [
	{
		...
		description: 'Công cụ Đặt hàng MONA LOGISTICS sẽ giúp bạn lên đơn hàng ngay khi đang duyệt sản phẩm trên giao diện của Taobao, ...'
	},
	{
		id: '2',
		...
		description: 'Thông qua sự hỗ trợ của công cụ đặt hàng, khách hàng có thể dễ dàng trực tiếp lên đơn hàng, quản lý đơn hàng.'
	},
	{
		id: '3',
...
export type TControllerList = typeof controllerList[keyof typeof controllerList]
