...
export const useCatalogue = ({
	...
	const userGroup = useQuery(['userGroupCatalogue'], async () => await catalogue.getUserGroup().then((res) => res.Data), {
		staleTime,
	...
	const userLevel = useQuery(['userLevelCatalogue'], async () => await catalogue.getUserLevel().then((res) => res.Data), {
		staleTime,
		initialDataUpdatedAt,
		// onError,
	...
	const userSale = useQuery(['userSaleCatalogue'], async () => await catalogue.getUser({ UserGroupId: 7 }).then((res) => res.Data), {
		staleTime,
		initialDataUpdatedAt,
		// onError,
	...
	const userOrder = useQuery(['userOrderCatalogue'], async () => await catalogue.getUser({ UserGroupId: 4 }).then((res) => res.Data), {
		staleTime,
		initialDataUpdatedAt,
		// onError,
	...
	const client = useQuery(['clientCatalogue'], async () => await catalogue.getUser({ UserGroupId: 2 }).then((res) => res.Data), {
		staleTime,
		initialDataUpdatedAt,
		// onError,
	...
	const controller = useQuery(['controllerCatalogue'], async () => await permitObject.getControllerList().then((res) => res.Data), {
		staleTime,
		initialDataUpdatedAt,
		// onError,
	...
	const warehouseVN = useQuery(['warehouseVNCatalogue'], async () => await catalogue.getWarehouseVN().then((res) => res.Data), {
		staleTime,
		initialDataUpdatedAt,
		// onError,
	...
	const shippingTypeToWarehouse = useQuery(
		...
		async () => await catalogue.getShippingTypeToWarehouse().then((res) => res.Data),
		{
			staleTime,
			initialDataUpdatedAt,
			// onError,
	...
	const bank = useQuery(['bankCatalogue'], async () => await catalogue.getBank().then((res) => res.Data), {
		staleTime,
		initialDataUpdatedAt,
		// onError,
		enabled: bankEnabled,
	...
	const pageType = useQuery(['pageCatalogue'], async () => await catalogue.getPageTypeCatalogue().then((res) => res.Data), {
		staleTime,
		initialDataUpdatedAt,
		// onError,
	...
	const bigPackage = useQuery(
		['bigPackageCatalogue'],
		async () => await catalogue.getBigPackageCatalogue({ Status: 0 }).then((res) => res.Data),
		{
			staleTime,
			initialDataUpdatedAt,
			// onError,
