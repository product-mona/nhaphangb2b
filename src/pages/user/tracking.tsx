...
const Index: TNextPageWithLayout = ({ connection }) => {
	...
	const { data, isLoading } = useQuery(['tracking', TransactionCode], () => smallPackage.getByTransactionCode({ TransactionCode }), {
				...
				<div className="tableBox px-4 tracking">
					...
					<div>
						{TransactionCode === null ? (
							<Empty description="Vui lòng nhập mã vận đơn trước" />
