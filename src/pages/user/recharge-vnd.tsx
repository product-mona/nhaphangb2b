...
import { HistoryRechargeVNDTable, ModalDelete, RechargeVNDForm, showToast, toast, UserLayout } from '~/components'
			...
			<div className="lg:flex mb-4">
				<div className="tableBox cardTopTable flex mr-4 !py-2 px-4 items-center rounded-[0px]">
					...
					<div>
						...
						<div className="text-[#f14f04] font-bold text-right">{_format.getVND(data?.Items?.[0]?.TotalAmount || 0)}</div>
					</div>
				</div>
			</div>
